...
while True:
    print("Welcome To The Doctor Finder\n")
    print("What Kind of Doctor Are you Looking for?\nChoose From The List Below!\n")
    print("Type 'ESC' and press Enter at any point in the program , to exit\n ")
    docdict = {0:"NeuroSurgeon",1:"Dentist",2:"Orthopaedic",3:"Physician",4:"Cardiologist",5:"Pediatrician",7:"Psychiatrist",8:"Rheumatologist",9:"Something Else"}
